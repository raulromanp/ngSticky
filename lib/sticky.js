        ...
        link: function linkFn($scope, $elem, $attrs) {
          ...
          $scope.getScrollTop = function () {
            if (typeof $window.pageYOffset !== 'undefined') {
              ...
              console.log("getScrollTop " + D.scrollTop);
          ...
          $scope.getTopOffset = function (element) {
            if (element.getBoundingClientRect) {
              ...
              console.log("getTopOffset " + pixels);
          ...
          $scope.$watch(function () {
            ...
            if (( typeof stickyLine === 'undefined' ) && newVal !== 0 && !isSticking) {
              ...
              console.log("================================================");
              console.log("DAME stickyLine: " + stickyLine);
              console.log("DAME newVal: " + newVal);
              console.log("DAME oldVal: " + oldVal);
              console.log("DAME offset: " + offset);
